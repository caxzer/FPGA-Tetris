...
set_property IOSTANDARD LVCMOS33 [get_ports {digit_on[0]}]
set_property PACKAGE_PIN U4 [get_ports {digit_on[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit_on[1]}]
set_property PACKAGE_PIN V4 [get_ports {digit_on[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit_on[2]}]
set_property PACKAGE_PIN W4 [get_ports {digit_on[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit_on[3]}]
...
#set property IOSTANDARD LVCMOS33 [get_ports {JXADC[7]}]
...
##USB HID (PS/2)
#set_property PACKAGE_PIN C17 [get_ports PS2CIK]
#set_property IOSTANDARD LVCMOS33 [get_ports PS2CIK]
#set_property PULLUP true [get_ports PS2CIK]
...
set_property IOSTANDARD LVCMOS33 [get_ports re_set]
